...
public class Endereco implements Serializable {
    ...
    public String getEndereco(){ return propEndereco.get();}
   
    @Column(length = 20, nullable = false)
    public String getNumeroEndereco(){ return propNumeroEndereco.get();}
   
    @Column(length = 200, nullable = false)
    public String getBairro(){ return propBairro.get();}
   
    @Column(length = 8, nullable = false)
    public String getCep(){ return propCEP.get();}
  
    @Column(length = 200)
    public String getComplemento(){ return propComplemento.get();}
  
    @Column(length = 100, nullable = false)
    public String getCidade(){ return propCidade.get();}
 
    @Column(length = 2, nullable = false)
    public String getUf(){ return propUF.get();}
   ...
   // public Boolean getSelecionado(){ return propStatus.get();}
    ...
    public void setEndereco(String value){ this.propEndereco.set(value); }
    public void setNumeroEndereco(String value){ this.propNumeroEndereco.set(value); }
    public void setBairro(String value){ this.propBairro.set(value); }
    public void setCep(String value){ this.propCEP.set(value); }
    public void setComplemento(String value){ this.propComplemento.set(value); }
    public void setCidade(String value){ this.propCidade.set(value); }
    public void setUf(String value){ this.propUF.set(value); }
