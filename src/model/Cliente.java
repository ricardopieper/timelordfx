...
public class Cliente implements Serializable {
    ...
    public String getCpf(){ return propCPF.get();}
    
    @OneToMany(mappedBy = "cliente")
    public List<Endereco> getEnderecos(){return propEnderecos.get();}
  
    public LocalDate getDatanasc(){ return propDatanasc.get();}
    ...
    @OneToMany(mappedBy = "cliente")
    public List<ArquivoCliente> getArquivos() { return propArquivos.get(); }
    
    
    public void setId(int value){ this.propId.set(value); }
    public void setNome(String value){ this.propNome.set(value); }
    public void setCpf(String value){ this.propCPF.set(value); }
    public void setDatanasc(LocalDate value){ this.propDatanasc.set(value); }
