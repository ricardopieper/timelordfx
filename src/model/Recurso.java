...
public class Recurso implements Serializable {
    ...
    public int getTipo(){ return propTipo.get();}
    
    @Column(nullable = false)
    public double getCustoPadrao(){ return propCustoPadrao.get(); }
    ...
    public void setTipo (int value) {this.propTipo.set(value); }
    public void setCustoPadrao(double value) {this.propCustoPadrao.set(value);}
