...
public class Projeto implements Serializable {
    ...
    public ListProperty<ArquivoProjeto> propProjetos = new SimpleListProperty<>();
    ...
    @ManyToOne
    public Endereco getEndereco() { return propEndereco.get(); }
   
    public LocalDate getDataPrevInicio(){ return propDataPrevInicio.get();}
    
    public LocalDate getDataPrevFim(){ return propDataPrevFim.get();}
    ...
    public LocalDate getDataCadastro(){ return propDataCadastro.get();}
    ...
    public void setEndereco(Endereco value){ this.propEndereco.set(value); }
    public void setDataPrevInicio(LocalDate value){ this.propDataPrevInicio.set(value); }
    public void setDataPrevFim(LocalDate value){ this.propDataPrevFim.set(value); }
    public void setCustoEstimado(double value){ this.propCustoEstimado.set(value); }
    public void setStatus(int value){ this.propStatus.set(value); }
    public void setDataCadastro(LocalDate value){ this.propDataCadastro.set(value); }
    public void setCliente(Cliente value){ this.propCliente.set(value); }
    public void setTarefaPrincipal(Tarefa value){ this.propTarefaPrincipal.set(value); }
    
    public void setArquivos(List<ArquivoProjeto> arquivos){
        propProjetos.clear();
        propProjetos.addAll(arquivos);
    }
}
